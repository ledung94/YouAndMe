pipeline {
    ...
    stages {
        ...
        //         sh "docker run --name khalid-mysql --rm --network dev -v khalid-mysql-data:/var/lib/mysql -e MYSQL_ROOT_PASSWORD=123456 -e MYSQL_DATABASE=db_example  -d mysql:8.0 "
        //         sh 'sleep 20'
        //         sh "docker exec -i khalid-mysql mysql --user=root --password=123456 < script"
        //     }
        // }
